...
async def start_stream_video(message, file, title, mystic):
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"🎬<b>__Video:__ </b> [Telegram ile Verilen Video]({link})\n\n👤<b>__Talep Eden:__ </b>{message.from_user.mention} \n🚧<b>__Parça Konumu:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Oynatılıyor:__ </b>[Telegram ile Verilen Video]({link})\n👤**__Talep Eden:__** {message.from_user.mention}"
        final_output = await message.reply_photo(
            photo="Utils/Telegram.JPEG",
